...
# Configuration Script – TCH-T2 - Rev. A

This **Configuration** script is designed for the **TCH-T2** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Configuration – TCH-T2 Rev. A

Este script de **Configuration** está diseñado para el modelo **TCH-T2** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
